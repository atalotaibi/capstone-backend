...
from .views import (UserCreateAPIView, QuestionCreateView,
                    QuestionListView, AnswerCreateView, AnswerListView, MajorListView, QuestionDelete)
...
urlpatterns = [
    ...
    path('question/create/', QuestionCreateView.as_view(), name='question-create'),
     path('question/<int:question_id>/delete/', QuestionDelete.as_view(), name='question-delete'),
